...
import { categories, projects, gradingFilms, categoryLabel, type WorkFilter } from '@/lib/portfolio';
...
export function Work() {
  ...
  const grading = <section className="grading-section" aria-labelledby="grading-heading">
    ...
    <GradingComparison />
    <div className="grading-film-grid">{gradingFilms.map(project => <ProjectCard key={project.id} project={project} />)}</div>
